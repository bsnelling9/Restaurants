...
class ResturantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resturant" do
    assert_difference("Resturant.count") do
      post resturants_url, params: { resturant: { description: @resturant.description, genre: @resturant.genre, glutenfree: @resturant.glutenfree, location: @resturant.location, name: @resturant.name, vegan: @resturant.vegan } }
    end
  ...
  test "should update resturant" do
    patch resturant_url(@resturant), params: { resturant: { description: @resturant.description, genre: @resturant.genre, glutenfree: @resturant.glutenfree, location: @resturant.location, name: @resturant.name, vegan: @resturant.vegan } }
