...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference("FoodItem.count") do
      post food_items_url, params: { food_item: { description: @food_item.description, ingrediants: @food_item.ingrediants, name: @food_item.name, resturant: @food_item.resturant, type: @food_item.type } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { description: @food_item.description, ingrediants: @food_item.ingrediants, name: @food_item.name, resturant: @food_item.resturant, type: @food_item.type } }
